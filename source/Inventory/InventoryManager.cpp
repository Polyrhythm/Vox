...
void InventoryManager::LoadDefaultInventory()
{
	...
	/*
	InventoryItem* pStone = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Block_Stone/Block_Stone.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/block_stone.tga", InventoryType_Block, eItem_Block_Stone, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Stone Block", "Stone block for world building", 1.0f, 1.0f, 1.0f, 3, -1, -1, -1, -1);
	InventoryItem* pWood = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Block_Wood/Block_Wood.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/block_wood.tga", InventoryType_Block, eItem_Block_Wood, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Wood Block", "Wood block for world building", 1.0f, 1.0f, 1.0f, 4, -1, -1, -1, -1);
	InventoryItem* pGrass = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Block_Grass/Block_Grass.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/block_grass.tga", InventoryType_Block, eItem_Block_Grass, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Grass Block", "Grass block for world building", 1.0f, 1.0f, 1.0f, 2, -1, -1, -1, -1);
	InventoryItem* pDirt = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Block_Dirt/Block_Dirt.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/block_dirt.tga", InventoryType_Block, eItem_Block_Dirt, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Dirt Block", "Dirt block for world building", 1.0f, 1.0f, 1.0f, 2, -1, -1, -1, -1);
	InventoryItem* pLeaf = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Block_Leaf/Block_Leaf.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/block_leaf.tga", InventoryType_Block, eItem_Block_Leaf, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Leaf Block", "Leaf block for world building", 1.0f, 1.0f, 1.0f, 2, -1, -1, -1, -1);
	*/

	/*
	InventoryItem* pAnvil = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Anvil/Anvil.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/anvil.tga", InventoryType_Item, eItem_Anvil, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Anvil", "Anvil for crafting", 1.0f, 1.0f, 1.0f, 1, -1, -1, -1, -1);
	InventoryItem* pChest = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Chest/Chest.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/chest.tga", InventoryType_Item, eItem_Chest, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Chest", "Chest for storing items", 1.0f, 1.0f, 1.0f, 1, -1, -1, -1, -1);
	InventoryItem* pFurnace = AddInventoryItem("/Users/ryanjones/Development/cpp/Vox/media/gamedata/items/Furnace/Furnace.item", "/Users/ryanjones/Development/cpp/Vox/media/textures/items/furnace.tga", InventoryType_Item, eItem_Furnace, ItemStatus_None, EquipSlot_RightHand, ItemQuality_Common, false, false, "Furnace", "Used for smelting ore", 1.0f, 1.0f, 1.0f, 1, -1, -1, -1, -1);
	*/
